...
设计:`docs/superpowers/specs/2026-07-01-textbooks-pipeline-design.md`、
`docs/superpowers/specs/2026-07-06-textbooks-io-restructure-design.md`(双根布局)。
...
| # | 阶段 | 执行者 | 输入 → 产出 | 碰交付/过程 |
|---|------|--------|------------|:-:|
| 1 | 分诊 triage | 确定性 Python | PDF → 路线 A/B/C(B=born-digital 登记不转) | — |
